...
public class SensorAccel extends Packet<SensorAccel> implements Settable<SensorAccel>, EpsilonComparable<SensorAccel>
{
   ...
   public SensorAccel(SensorAccel other)
   {
      this();
      set(other);
   }

   public void set(SensorAccel other)
   {
   ...
   public static Supplier<SensorAccelPubSubType> getPubSubType()
   {
      return SensorAccelPubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(SensorAccel other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof SensorAccel)) return false;

      SensorAccel otherMyClass = (SensorAccel) other;
