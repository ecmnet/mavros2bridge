...
public class EstimatorAidSource2d extends Packet<EstimatorAidSource2d> implements Settable<EstimatorAidSource2d>, EpsilonComparable<EstimatorAidSource2d>
{
   /**
   ...
   public EstimatorAidSource2d()
   {
      observation_ = new double[2];

      observation_variance_ = new float[2];

      innovation_ = new float[2];

      innovation_filtered_ = new float[2];

      innovation_variance_ = new float[2];

      test_ratio_ = new float[2];

      test_ratio_filtered_ = new float[2];

   }

   public EstimatorAidSource2d(EstimatorAidSource2d other)
   {
      this();
      set(other);
   }

   public void set(EstimatorAidSource2d other)
   {
   ...
   public static Supplier<EstimatorAidSource2dPubSubType> getPubSubType()
   {
      return EstimatorAidSource2dPubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(EstimatorAidSource2d other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof EstimatorAidSource2d)) return false;

      EstimatorAidSource2d otherMyClass = (EstimatorAidSource2d) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("EstimatorAidSource2d {");
