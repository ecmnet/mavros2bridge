...
public class SensorAccelFifo extends Packet<SensorAccelFifo> implements Settable<SensorAccelFifo>, EpsilonComparable<SensorAccelFifo>
{
   /**
   ...
   public SensorAccelFifo(SensorAccelFifo other)
   {
      this();
      set(other);
   }

   public void set(SensorAccelFifo other)
   {
   ...
   public static Supplier<SensorAccelFifoPubSubType> getPubSubType()
   {
      return SensorAccelFifoPubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(SensorAccelFifo other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof SensorAccelFifo)) return false;

      SensorAccelFifo otherMyClass = (SensorAccelFifo) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("SensorAccelFifo {");
