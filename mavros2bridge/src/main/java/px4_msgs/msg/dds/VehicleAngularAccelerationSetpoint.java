...
public class VehicleAngularAccelerationSetpoint extends Packet<VehicleAngularAccelerationSetpoint> implements Settable<VehicleAngularAccelerationSetpoint>, EpsilonComparable<VehicleAngularAccelerationSetpoint>
{
   /**
   ...
   public VehicleAngularAccelerationSetpoint()
   {
      xyz_ = new float[3];

   }

   public VehicleAngularAccelerationSetpoint(VehicleAngularAccelerationSetpoint other)
   {
      this();
      set(other);
   }

   public void set(VehicleAngularAccelerationSetpoint other)
   {
   ...
   public static Supplier<VehicleAngularAccelerationSetpointPubSubType> getPubSubType()
   {
      return VehicleAngularAccelerationSetpointPubSubType::new;
   }
   ...
   @Override
   public boolean epsilonEquals(VehicleAngularAccelerationSetpoint other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof VehicleAngularAccelerationSetpoint)) return false;

      VehicleAngularAccelerationSetpoint otherMyClass = (VehicleAngularAccelerationSetpoint) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("VehicleAngularAccelerationSetpoint {");
