package com.comino.mavros2bridge.types;
...
public class ImagePubSubType implements us.ihmc.pubsub.TopicDataType<sensor_msgs.msg.dds.Image>
{
	...
	public ImagePubSubType(int size) {
		bufferSize = size;
	}
	...
	public static int getMaxCdrSerializedSize(int current_alignment)
	{
		...
		current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);current_alignment += (bufferSize * 1) + us.ihmc.idl.CDR.alignment(current_alignment, 1);
	...
	public static void write(sensor_msgs.msg.dds.Image data, us.ihmc.idl.CDR cdr)
	{
		...
		if(data.getData().size() <= bufferSize)
